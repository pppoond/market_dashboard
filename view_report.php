        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var count_success1 = 0;
                    var count_success2 = 0;
                    var count_success3 = 0;
                    var count_success4 = 0;
                    var count_success5 = 0;
                    var count_success6 = 0;
                    var count_success7 = 0;
                    ...
                    var data = {
                        ...
                        datasets: [{
                            ...
                            {
                                label: "สำเร็จ",
                                data: [count_success7, count_success6, count_success5, count_success4, count_success3, count_success2, count_success1],
                            ...
                            {
                                label: "ยกเลิก",
                                data: [count_cancel7, count_cancel6, count_cancel5, count_cancel4, count_cancel3, count_cancel2, count_cancel1],
